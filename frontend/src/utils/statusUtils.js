...
export const STATUS_OPTIONS = [
  { value: 'available_now', label: 'Available Now', color: 'emerald', icon: '🟢' },
  { value: 'available_from_date', label: 'Available From Date', color: 'blue', icon: '🔵' },
  { value: 'on_hold', label: 'On Hold', color: 'amber', icon: '🟡' },
  { value: 'reserved', label: 'Reserved', color: 'purple', icon: '🟣' },
  { value: 'rented', label: 'Rented', color: 'red', icon: '🔴' },
];
